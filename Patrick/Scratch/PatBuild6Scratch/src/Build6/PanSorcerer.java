...
public class PanSorcerer extends JPanel implements ActionListener {
    ...
    private boolean isCol1 = false, isCol2 = false;
    private Main main = new Main();

    public PanSorcerer() throws IOException {
    ...
    public void actionPerformed(ActionEvent e) {
        if (hero.getAttack() == false && isCol2 == false && isCol1 == false) {
            hero.move();
        }
        if (fireball1.isVisible()) {
            fireball1.move();
    ...
    private class Keys extends KeyAdapter {
        ...
        public void keyReleased(KeyEvent e) {
            ...
            if (hero.getPause()) {
                timer.stop();
            } else if (!hero.getPause() && !timer.isRunning()) {
                timer.start();
            }
        }
    }
